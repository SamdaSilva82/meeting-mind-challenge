...
exports.MeetingsModule = MeetingsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [meetings_service_1.MeetingsService, meeting_analysis_service_1.MeetingAnalysisService],
        exports: [meeting_analysis_service_1.MeetingAnalysisService],
    })
], MeetingsModule);
